 ...
 */
public class DeleteAuthorization extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String idParam = request.getParameter("id_authorization");
        AuthorizationDAO authorizationDAO = new AuthorizationDAO();
        if (idParam != null && !idParam.isEmpty()) {
            int id_authorization = Integer.parseInt(idParam);
            
            boolean success = authorizationDAO.deleteAuthorization(id_authorization);
