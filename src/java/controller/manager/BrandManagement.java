...
public class BrandManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        TrainBrand trainBrand = trainBrandDAO.getTrainBrandsByManager(manager.getId_manager());
        System.out.println(trainBrand.getName_train_brand());
        request.setAttribute("trainBrand", trainBrand);
        request.getRequestDispatcher("Views/Manager/BrandManagement.jsp").forward(request, response);
    }
