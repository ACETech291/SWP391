                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <h4 class="mb-1"> ${customer.userName}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-8 pe-lg-2">
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body bg-body-tertiary">
                                                    <form class="row g-3" action="customerdetail" method="POST">
                                                        <input type="hidden" name="id" value="${customer.id_customer}" />
                                                        <div class="col-lg-12"> <label class="form-label" for="first-name">Tên người dùng</label><input class="form-control" type="text" value="${customer.userName}" readonly/></div>
                                                        <div class="col-lg-12"> <label class="form-label" for="phone">Số điện thoại</label><input class="form-control" type="text" value="${customer.phoneNumber}" readonly/></div>
                                                        <div class="col-lg-12"> <label class="form-label" for="email1">Địa chỉ Email</label><input class="form-control" type="text" value="${customer.email}" readonly/></div>
                                                            <c:choose>
