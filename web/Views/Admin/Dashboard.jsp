                    ...
                    <div class="w-100">
                        <div class="d-flex flex-between-center">
                            ...
                            <a class="navbar-brand me-1 me-sm-3" href="dashboard">
                                <div class="d-flex align-items-center"><jsp:include page="../includes/icon.jsp"></jsp:include></div>
                                </a>
                    ...
                    <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="toggle-icon-wrapper">
                                ...
                                <div class="d-flex align-items-center py-3"><img class="me-2" src="${pageContext.request.contextPath}/images/icon.png" alt="image" width="40"/><span class="font-sans-serif text-primary">Fast Rail</span></div>
                            </a>
                        </div>
