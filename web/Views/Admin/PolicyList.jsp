...
<html lang="vi">
    <head>
        ...
        <title>Thông tin chính sách</title>
    ...
    <body>
        <div class="container mt-4">
            <h2 class="text-center text-primary">Thông tin chính sách</h2>
            ...
            <%
                    ...
                    %>
                    <div style="color: green;">Cập nhật chính sách thành công!</div>
                    <% }%>
            <table id="policyTable" class="table table-hover table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>${policy.create_at}</td>
                        <td>
                            <span class="badge ${policy.status_policy == 1 ? 'bg-success' : 'bg-danger'}">
                                ${policy.status_policy == 1 ? "Hoạt động" : "Không hoạt động"}
                            </span>
                        </td>
                        <td>
                            <a href="EditPolicy?id=${policy.id_policy}" class="btn btn-warning btn-sm">
