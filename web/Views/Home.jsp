                            ...
                            <tbody id="trip-list">
                                <c:if test="${empty listTripDTO and empty message}">
                                    <c:forEach  var="trip" items="${listTrips}" begin="0" end="49">
                                        <tr>
                                            ...
                                            <td class="text-center align-middle"><a href="${pageContext.request.contextPath}/ChooseSeat?id_trip=${trip.id_trip}&date=${formattedDate}&start_time=${trip.start_time}&end_time=${trip.end_time}" class="btn btn-primary">Đặt vé ngay</a></td>
                                        </tr>
                                    </c:forEach>  
                                </c:if>
                                <c:forEach var="trip" items="${listTripDTO}">
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">${trip.name_train}</td>
                                        <td class="text-center align-middle">${trip.price_trip}</td>
                                        <td class="text-center align-middle"><a href="${pageContext.request.contextPath}/ChooseSeat?id_trip=${trip.id_trip}&date=${empty date ? formattedDate : date}&start_time=${trip.start_time}&end_time=${trip.end_time}" class="btn btn-primary">Đặt vé ngay</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
