    ...
    <a class="navbar-brand" href="Manager">
      <div class="d-flex align-items-center py-3">
        <img
          ...
          alt="image"
          width="40"
        /><span class="font-sans-serif text-primary">FRT</span>
      </div>
    </a>
  </div>
        ...
        <li class="nav-item">
          <a class="nav-link" href="Manager">
            <div class="d-flex align-items-center">
              ...
              ><span class="nav-link-text ps-1">Thống kê</span>
            </div>
          </a>
        </li>
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="home" role="button">
            <div class="d-flex align-items-center">
              ...
              ></span>
              <span class="nav-link-text ps-1">Trang chủ</span>
            </div>
          </a>
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="Logout" role="button">
            <div class="d-flex align-items-center">
              ...
              ><span class="nav-link-text ps-1">Đăng xuất</span>
            </div>
          </a>
        </li>
      </ul>
  ...
  <a class="navbar-brand me-1 me-sm-3" href="index.html">
    <div class="d-flex align-items-center py-3">
      <img
        ...
        alt="image"
        width="40"
      /><span class="font-sans-serif text-primary">Fast Rail Ticket</span>
    </div>
  </a>
</nav>
